...
class statistics:
    ...
    def render (this, filter = {True: '全校'}):
        for key in this.view:
            if key in filter:
                q1 = 100 * this.view[key][1][1] / sum(this.view[key][1])
                q2 = 100 * this.view[key][2][0] / sum(this.view[key][2])
                q3 = 100 * this.view[key][3][1] / sum(this.view[key][3])
                q4 = 100 * this.view[key][4][1] / sum(this.view[key][4])
                q5 = 100 * this.view[key][5][1] / sum(this.view[key][5])
                q6 = 100 * this.view[key][6][1] / sum(this.view[key][6])
                print (
